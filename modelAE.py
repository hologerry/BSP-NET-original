...
from ops import conv3d, linear, lrelu
from utils import write_ply_triangle, write_ply_polygon, sample_points_polygon_vox64, write_ply_point_normal

# from bspt_slow import digest_bsp, get_mesh, get_mesh_watertight


class BSP_AE(object):
    def __init__(self, sess, phase, sample_vox_size, is_training=False, ef_dim=32, c_dim=256,
                 p_dim=4096, dataset_name='default', checkpoint_dir=None, sample_dir=None, data_dir='./data'):
        """
        Args:
            too lazy to explain
        """
    ...
    def train(self, config):
        ...
        for epoch in range(0, training_epoch):
            ...
            for idx in range(batch_num):
                ...
                avg_loss_tt += errTT
                avg_num += 1
            print(str(self.sample_vox_size)+" Epoch: [%2d/%2d] time: %4.4f, loss_sp: %.6f, loss_total: %.6f" %
