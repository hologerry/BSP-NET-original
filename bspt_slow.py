...
def digest_bsp_robust(bsp_convex, bias):
    faces = [
        [[-1.0, 0.0, 0.0, border_limit], np.array([border_limit, -border_limit, border_limit]), np.array([border_limit, -border_limit, -border_limit]), np.array([border_limit, border_limit, -border_limit]), np.array([border_limit, border_limit, border_limit])],  # noqa
        [[1.0, 0.0, 0.0, border_limit], np.array([-border_limit, border_limit, border_limit]), np.array([-border_limit, border_limit, -border_limit]), np.array([-border_limit, -border_limit, -border_limit]), np.array([-border_limit, -border_limit, border_limit])],  # noqa
        [[0.0, -1.0, 0.0, border_limit], np.array([border_limit, border_limit, border_limit]), np.array([border_limit, border_limit, -border_limit]), np.array([-border_limit, border_limit, -border_limit]), np.array([-border_limit, border_limit, border_limit])],  # noqa
        [[0.0, 1.0, 0.0, border_limit], np.array([-border_limit, -border_limit, border_limit]), np.array([-border_limit, -border_limit, -border_limit]), np.array([border_limit, -border_limit, -border_limit]), np.array([border_limit, -border_limit, border_limit])],  # noqa
        [[0.0, 0.0, -1.0, border_limit], np.array([-border_limit, border_limit, border_limit]), np.array([-border_limit, -border_limit, border_limit]), np.array([border_limit, -border_limit, border_limit]), np.array([border_limit, border_limit, border_limit])],  # noqa
        [[0.0, 0.0, 1.0, border_limit], np.array([border_limit, border_limit, -border_limit]), np.array([border_limit, -border_limit, -border_limit]), np.array([-border_limit, -border_limit, -border_limit]), np.array([-border_limit, border_limit, -border_limit])]  # noqa
    ]
